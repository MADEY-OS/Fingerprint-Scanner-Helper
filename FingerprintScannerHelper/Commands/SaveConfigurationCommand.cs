...
namespace FingerprintScannerHelper.Commands
{
    public class SaveConfigurationCommand : BaseCommand
    {
        ...
        {
            _sharedServices.ModifyConfiguration(_settingsViewModel.SourcePath, _settingsViewModel.DestinationPath, _settingsViewModel.PortName, _settingsViewModel.PortBaud, Int32.Parse(_settingsViewModel.PersonNumber), _settingsViewModel.SelectedFinger + 1, _settingsViewModel.SelectedVariant + 1);
